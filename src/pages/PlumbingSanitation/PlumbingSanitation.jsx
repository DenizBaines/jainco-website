  ...
  return (
    ...
    <div className="ps-container">
      ...
      <div className="ps-description">
        <p>
          We offer comprehensive plumbing and sanitation solutions for residential, 
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>Complete water supply and drainage system design & execution</li>
          <li>Use of ISI-marked CPVC, UPVC, GI, and PPR piping materials</li>
          <li>Leak-proof jointing and pressure-tested installations</li>
          <li> Rainwater harvesting and greywater reuse systems</li>
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          ...
          <li>Industrial factories and warehouses</li>
          ...
          standards and client expectations. With a sharp focus on sustainability and innovation, we 
          are committed to building smarter sanitation systems that serve communities for years to come.
          </p>
