  ...
  return (
    ...
    <div className="wts-container">
      ...
      <div className="wts-description">
        <p>
          Our water treatment systems are designed to ensure the supply of safe, 
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>High-capacity pipeline networks for bulk water movement</li>
          <li>Use of corrosion-resistant DI, MS, HDPE, and PVC piping</li>
          <li>Leak-proof jointing systems and thrust block design</li>
          <li> Proper pressure zoning and surge protection</li>
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>Regional and intercity water supply networks</li>
          <li>Water transmission from rivers, dams, or reservoirs</li>
          <li>Industrial water pipelines and process systems</li>
