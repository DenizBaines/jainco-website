  ...
  return (
    ...
    <div className="stp-container">
      ...
      <div className="stp-description">
        ...
        <p>
        ✅ Key Features of Our Sewerage Treatment Plants :-
        </p>
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>Advanced treatment methods: MBBR, SBR, MBR, and ASP</li>
          <li>Compact and space-saving modular designs</li>
          <li>Treated water usable for gardening, flushing, or landscaping</li>
          <li>Odor-free and noiseless operations</li>
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>Residential complexes and societies</li>
          <li>Commercial and office buildings</li>
          <li> Industrial parks and SEZs</li>
          <li>Educational and institutional campuses</li>
