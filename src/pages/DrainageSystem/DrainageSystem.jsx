  ...
  return (
    ...
    <div className="ds-container">
      ...
      <div className="ds-description">
        ...
        Jainco Group’s drainage systems are built to perform under all conditions. Our focus on proper gradient planning, 
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>Complete stormwater and sewage drainage solutions</li>
          <li>Design with proper slope, catch basins, and manholes</li>
          <li>Use of high-durability RCC, HDPE, and PVC piping</li>
          <li>Grating systems for surface water collection</li>
        ...
        <ul style={{ listStyleType: 'disc', textAlign: 'left' }}>
          <li>Housing societies and gated communities</li>
          <li>Commercial buildings and parking lots</li>
          <li>Roads, highways, and footpaths</li>
          ...
          of urban hygiene and safety. With a focus on precision, durability, and long-term performance, 
          we provide drainage infrastructure that supports healthy environments and sustainable urban growth. 
          Our work ensures that water flows where it should—away from your property, efficiently and safely.
          </p>
